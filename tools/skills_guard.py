...
Trust levels:
  - builtin:   Ships with Norual. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.hermes/\.env|\~/\.hermes/\.env',
     ...
     "directly references Norual secrets file"),
    ...
    (r'\.hermes/config\.yaml|\.hermes/SOUL\.md',
     ...
     "references Norual configuration files directly"),
...
# scan. `.skillignore` is the Norual-native name; `.clawhubignore` is honored
