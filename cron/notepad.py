...
Write path is the CLI (``norual cron notepad <job_id> set <key> <value>``),
...
def render_notepad_section(job_id: str) -> str:
    ...
    return (
        ...
        f"`norual cron notepad {job_id} set <key> <value>` "
        f"(also: get/delete/list; `norual cron notepad {job_id} delete "
