"""
Cron job scheduling system for Norual Agent.
...
Cron jobs are executed automatically by the gateway daemon:
    norual gateway install    # Install as a user service
    sudo norual gateway install --system  # Linux servers: boot-time system service
    norual gateway            # Or run in foreground
