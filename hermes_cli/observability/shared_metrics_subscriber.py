"""Relay subscriber for the persisted Norual shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Norual counters from Relay lifecycle events."""
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Norual shared metric: %s",
                    metric_name,
                    exc_info=True,
                )
