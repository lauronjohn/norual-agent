...
Usage:
    norual pairing list              # Show all pending + approved users
    norual pairing approve <platform> <request-id|code>  # Approve a pairing request
    norual pairing revoke <platform> <user_id> # Revoke user access
    norual pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle norual pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: norual pairing {list|approve|revoke|clear-pending}")
        print("Run 'norual pairing --help' for details.")
...
def _cmd_list(store):
    ...
    if pending:
        ...
        print("\n  Approve with: norual pairing approve <platform> <request-id>")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print("  Run 'norual pairing list' to see pending requests.\n")
