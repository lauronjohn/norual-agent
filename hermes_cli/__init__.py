"""
Norual CLI - Unified command-line interface for Norual Agent.

Provides subcommands for:
- norual chat          - Interactive chat (same as ./hermes)
- norual gateway       - Run gateway in foreground
- norual gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `norual setup` on a fresh Pi.
