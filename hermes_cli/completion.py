"""Shell completion script generation for norual CLI.
...
def generate_bash(parser: argparse.ArgumentParser) -> str:
    ...
    return f"""# Norual Agent bash completion
# Add to ~/.bashrc:
#   eval "$(norual completion bash)"
...
# Norual Agent zsh completion
# Add to ~/.zshrc:
#   eval "$(norual completion zsh)"
...
{top_cmds_str}
            ...
            _describe 'norual command' subcmds
            ;;
        args)
            case ${{line[1]}} in
{sub_cases_str}
...
def generate_fish(parser: argparse.ArgumentParser) -> str:
    ...
    lines: list[str] = [
        "# Norual Agent fish completion",
        "# Add to your config:",
        "#   norual completion fish | source",
        "",
        ...
        "",
        "# Complete profile names after -p / --profile",
        "complete -c norual -f -s p -l profile"
