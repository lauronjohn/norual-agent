"""``norual tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'norual tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # norual tools list [--platform cli]
    ...
    # norual tools disable <name...> [--platform cli]
    ...
    # norual tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `norual tools` runs after you pick a provider that\n"
