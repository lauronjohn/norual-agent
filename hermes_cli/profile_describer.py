...
Used by ``norual profile describe <name> --auto`` and the dashboard's
...
_SYSTEM_PROMPT = """You are a profile-describer for the Norual Agent kanban board.
...
Rules:
  ...
  - Never write "Norual Agent profile" or other meta-narration.
