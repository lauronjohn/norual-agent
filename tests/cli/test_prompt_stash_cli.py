...
def _make_cli(**kwargs):
    """Create a NorualCLI with prompt_toolkit stubbed out."""
    _clean_config = {
        "model": {
...
class TestKeybindingRegistration:
    ...
    ``NorualCLI.run()``'s local ``KeyBindings`` instance, so they are not
