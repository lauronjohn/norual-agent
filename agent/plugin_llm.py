...
Plugins built on Norual Agent often need to make their own LLM calls
...
Today the only stable plugin surfaces extend an existing Norual
...
embedded slugs, no shorthands. This mirrors Norual' main config
...
handles every provider, fallback chain, and per-task override Norual
supports.
"""
