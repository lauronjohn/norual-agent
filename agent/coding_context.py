"""Coding-context awareness — base Norual, every interactive surface.

When the user runs Norual inside a code workspace (CLI, TUI, desktop app, or an
editor over ACP), Norual shifts into a **coding posture**. This module is the
...
def is_coding_context(
    *,
    ...
    """Whether Norual should operate in its coding posture right now."""
