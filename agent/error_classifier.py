...
# ``data:`` field before Norual receives a completion chunk.  Keeping this
...
# case: a stream dies mid-response and Norual persists a content-less
...
# Request parameters that Norual sends on SOME routes only, paired with the
