...
projection into Norual' display, approval bridging, transcript projection into
...
"codex_app_server"`. Norual' default tool dispatch is unchanged when this
...
class CodexAppServerClient:
    ...
    def __init__(
        ...
        # `os.environ.copy()` also handed it every Tier-1 Norual secret — gateway
