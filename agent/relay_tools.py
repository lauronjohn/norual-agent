"""Core NeMo Relay adapter for Norual tool execution."""
    ...
    try:
        ...
        if (
            ...
            logger.warning(
                ...
                "returning the Norual tool result",
                exc_info=True,
            )
...
def _run_awaitable(value: Any) -> Any:
    ...
    raise RuntimeError(
        "Synchronous Norual Relay tool execution cannot run on an active event-loop thread"
    )
