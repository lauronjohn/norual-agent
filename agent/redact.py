...
def mask_secret(
    ...
    *,
    ...
    Canonical helper for display-time redaction across Norual — used by
    ``norual config``, ``norual status``, ``norual dump``, and anywhere
...
def redact_sensitive_text(
    ...
    *,
    ...
    for URLs, ``"eyJ" in text`` for JWTs). On a typical norual log line
