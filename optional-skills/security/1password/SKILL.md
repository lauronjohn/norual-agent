...
version: 1.0.0
author: arceus77-7, enhanced by Norual Agent
license: MIT
...
- `tmux` available for stable authenticated sessions during Norual terminal calls (desktop app flow only)
...
### Service Account (recommended for Norual)
...
## Norual Execution Pattern (desktop app flow)

Norual terminal commands are non-interactive by default and can lose auth context between calls.
