...
# When the user hasn't picked a reasoning effort, Norual passes
...
# ON at this effort — matching the "medium (default)" that Norual' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map Norual' effort vocabulary onto Solar's accepted set via the
