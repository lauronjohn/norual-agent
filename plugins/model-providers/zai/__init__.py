...
request omits ``thinking``.  Norual' ``reasoning_config = {"enabled": False}``
...
:meth:`ZaiProfile.build_api_kwargs_extras` translates the Norual reasoning
...
(per Z.AI / BigModel docs).  Norual' richer effort scale is collapsed onto
...
def _glm_5_2_reasoning_effort(
    ...
    """Map Norual reasoning effort onto GLM's native vocabulary.
