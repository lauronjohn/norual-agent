...
# ``model_tools`` import time, so ``norual status``, ``norual chat``, etc.
...
#     fresh "Norual is thinking…" card during the small window between
...
def _mime_for_message_type(mime: str) -> MessageType:
    """Map a MIME string to a norual MessageType.
...
class GoogleChatAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        # they don't sit in the chat forever as "Norual is thinking…".
    ...
    async def _build_message_event(
        ...
        """Parse a Chat API message into a norual MessageEvent."""
        space = envelope.get("space") or msg.get("space") or {}
    ...
    async def send_typing(self, chat_id: str, metadata: Any = None) -> None:
        """Post a visible 'Norual is thinking…' marker message.
        ...
        "Norual is thinking…" stuck in chat forever, plus one card that
    ...
    async def stop_typing(self, chat_id: str) -> None:
        ...
        Google Chat has no separate typing API: the "Norual is thinking…"
    ...
    async def on_processing_complete(
        ...
        see "Norual is thinking…" stuck forever.
        """
    ...
    async def _consume_typing_card_with_text(
        ...
        creating a fresh "Norual is thinking…" card during any subsequent
...
def interactive_setup() -> None:
    """Walk the user through Google Chat configuration via ``norual setup``.
    ...
    print_info("Restart the gateway: norual gateway restart")
...
async def _standalone_send(
    ...
    *,
    ...
    runner is not in this process (e.g. ``norual cron`` running as a
    separate process from ``norual gateway``).  Without this hook,
...
def register(ctx) -> None:
    """Plugin entry point — called by the Norual plugin system at startup.
    ...
    ctx.register_platform(
        ...
        install_hint="Run `norual setup` to install Google Chat support.",
        ...
        # the "Norual is thinking..." marker patches and edit overhead.
        ...
        platform_hint=(
            ...
            "are generating a response, a 'Norual is thinking…' marker message "
